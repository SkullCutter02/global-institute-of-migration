    ...
    <>
      <SimpleGrid mt={10} columns={{ base: 1, md: 3 }} spacing={5}>
        <Box w={"100%"}>
          ...
          <Text my={2} fontFamily={"Solido-Bold"} color={"gray.400"}>
            Feb 11
          </Text>
        ...
        <Box w={"100%"}>
          <Image maxH={"250px"} objectFit={"cover"} src={"/placeholder2.png"} w={"100%"} />
          <Text my={2} fontFamily={"Solido-Bold"} color={"gray.400"}>
            Feb 11
          </Text>
          <PreviewHeading>Jason Reconsiders His Sexuality As Jonathan Pins Him On Bed</PreviewHeading>
        ...
        <Box w={"100%"}>
          <Image maxH={"250px"} objectFit={"cover"} src={"/placeholder.png"} w={"100%"} />
          <Text my={2} fontFamily={"Solido-Bold"} color={"gray.400"}>
            Feb 11
          </Text>
          <PreviewHeading>Jason Reconsiders His Sexuality As Jonathan Pins Him On Bed</PreviewHeading>
