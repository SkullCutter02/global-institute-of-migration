...
export interface paths {
  ...
  "/items/videos": {
    ...
    /** Create a new videos item. */
    post: operations["createItemsVideos"];
  };
  "/items/videos/{id}": {
    /** Retrieve a single videos item by unique identifier. */
    get: operations["readSingleItemsVideos"];
    /** Delete an existing videos item. */
    delete: operations["deleteSingleItemsVideos"];
    /** Update an existing videos item. */
    patch: operations["updateSingleItemsVideos"];
  };
  "/items/writers": {
    /** List the writers items. */
    get: operations["readItemsWriters"];
    /** Create a new writers item. */
    post: operations["createItemsWriters"];
  };
  "/items/writers/{id}": {
    /** Retrieve a single writers item by unique identifier. */
    get: operations["readSingleItemsWriters"];
    /** Delete an existing writers item. */
    delete: operations["deleteSingleItemsWriters"];
    /** Update an existing writers item. */
    patch: operations["updateSingleItemsWriters"];
  };
  "/activity": {
...
export interface operations {
  ...
  createItemsVideos: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsVideos"][]
          | components["schemas"]["ItemsVideos"];
      };
    };
  };
  ...
  updateSingleItemsVideos: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsVideos"];
      };
    };
  };
  /** List the writers items. */
  readItemsWriters: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsWriters"][];
          };
        };
      };
      401: components["responses"]["UnauthorizedError"];
  ...
  createItemsWriters: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsWriters"][]
          | components["schemas"]["ItemsWriters"];
      };
    };
  };
  /** Retrieve a single writers item by unique identifier. */
  readSingleItemsWriters: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsWriters: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsWriters"];
      };
    };
  };
  /** Returns a list of activity actions. */
